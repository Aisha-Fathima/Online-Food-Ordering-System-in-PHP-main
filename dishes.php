<!--DBMS PROJECT-AISHA FATHIMA MOHAMMED -- ONLINE FOOD ORDERING WEBSITE-->
...
<head>
    ...
    <link rel="icon" href="#">
    <title>Dishes || Online Food Ordering System-DBMS PROJECT-Aisha Fathima Mohammed</title>
...
?>
                                ...
                                <div class="form-group row no-gutter">
                                    <div class="col-xs-8">
                                        <input type="text" class="form-control b-r-0" value=<?php echo "₹".str_replace('$','',$item["price"]); ?> readonly id="exampleSelect1">
...
?>
                        ...
                        <div class="widget-body">
                            <div class="price-wrap text-xs-center">
                                <p>TOTAL</p>
                                <h3 class="value"><strong><?php echo "₹".str_replace('$','',$item_total); ?></strong></h3>
                                <p>Free Delivery!</p>
                                <?php
                                        if($item_total==0){
                                        ?>
